---
name: web-access-headless
license: MIT
upstream: https://github.com/eze-is/web-access
upstream_base_commit: 1116c082a7f13860c3befd5307a272d6a120206f
description:
  ...
  与上游差异：不复用用户日常 Chrome，而是启动一个独立的 headless Chrome 实例（端口 9333、profile ~/.cache/chrome-cdp-profile），全程不影响用户主浏览器窗口；代价是登录态独立维护。
metadata:
  upstream_author: 一泽Eze
  fork_maintainer: yuhao (MokusMokun)
  version: "2.4.1-headless.1"
---
